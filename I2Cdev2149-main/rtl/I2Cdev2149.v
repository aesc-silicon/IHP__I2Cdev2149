...
// Component : SG13CMOS5LTop
// Git hash  : d1a93a1a23d610acccf55c717a4e3289b833363f
// 
...
module I2cGpioExpander (
  ...
  reg        [7:0]    link_data;
  reg                 link_error;
  wire       [7:0]    switch_I2cGpioExpander_l144;
  wire       [7:0]    switch_I2cGpioExpander_l187;
  `ifndef SYNTHESIS
  ...
  I2cDeviceCtrl i2cCtrl (
    ...
    .io_config_clockDividerReload (1'b1                             ), //i
  ...
  assign when_I2cGpioExpander_l50 = (! i2cConfig_latch);
  ...
  always @(*) begin
    ...
    case(link_state)
      ...
      State_WRITE : begin
        case(switch_I2cGpioExpander_l187)
          8'h01 : begin
          end
          8'h02 : begin
          end
  ...
  assign switch_I2cGpioExpander_l144 = link_regAddr;
  assign switch_I2cGpioExpander_l187 = link_regAddr;
  always @(posedge clock) begin
    if(!reset) begin
      ...
      if(when_I2cGpioExpander_l50) begin
      ...
      case(link_state)
        ...
        State_READ : begin
          case(switch_I2cGpioExpander_l144)
            8'h0 : begin
...
module GpioCtrl (
  ...
  (* keep_hierarchy = "TRUE" *) BufferCC_2 io_gpio_pins_read_buffercc (
...
module I2cDeviceCtrl (
  ...
  wire                filter_clockDivider_io_tick;
  ...
  reg                 filter_sda;
  reg                 filter_scl;
  wire                when_I2cDeviceCtrl_l79;
  wire                when_I2cDeviceCtrl_l82;
  wire                sclEdge_rise;
  wire                sclEdge_fall;
  wire                sclEdge_toggle;
  ...
  wire                when_I2cDeviceCtrl_l113;
  wire                when_I2cDeviceCtrl_l116;
  reg        [1:0]    ctrl_state;
  ...
  wire                when_I2cDeviceCtrl_l164;
  wire                when_I2cDeviceCtrl_l165;
  wire                when_I2cDeviceCtrl_l168;
  wire                when_I2cDeviceCtrl_l172;
  wire                when_I2cDeviceCtrl_l176;
  wire                when_I2cDeviceCtrl_l177;
  wire                when_I2cDeviceCtrl_l179;
  wire                when_I2cDeviceCtrl_l184;
  wire                when_I2cDeviceCtrl_l187;
  wire                when_I2cDeviceCtrl_l202;
  wire                io_cmd_fire;
  `ifndef SYNTHESIS
  ...
  assign when_I2cDeviceCtrl_l79 = (&{(filter_sampler_sdaSamples_2 != filter_sda),{(filter_sampler_sdaSamples_1 != filter_sda),(filter_sampler_sdaSamples_0 != filter_sda)}});
  assign when_I2cDeviceCtrl_l82 = (&{(filter_sampler_sclSamples_2 != filter_scl),{(filter_sampler_sclSamples_1 != filter_scl),(filter_sampler_sclSamples_0 != filter_scl)}});
  ...
  assign when_I2cDeviceCtrl_l113 = ((detector_start || sclEdge_rise) || sclEdge_fall);
  assign when_I2cDeviceCtrl_l116 = (filter_clockDivider_io_tick && timeout_transmission);
  assign ctrl_address = ctrl_shiftRegister[7 : 1];
  assign ctrl_data = ctrl_shiftRegister[7 : 0];
  assign ctrl_write = (! ctrl_read);
  assign when_I2cDeviceCtrl_l150 = ((detector_start || detector_stop) || (timeout_value == io_config_timeout));
  assign _zz_ctrl_bitCounter[4 : 0] = 5'h1f;
  assign when_I2cDeviceCtrl_l164 = (((ctrl_frameCounter == 4'b0000) || (((ctrl_frameCounter == 4'b0001) || ((! (ctrl_frameCounter == 4'b0000)) && (! (ctrl_frameCounter == 4'b0001)))) && ctrl_write)) && (ctrl_bitCounter == 5'h08));
  assign when_I2cDeviceCtrl_l165 = ((ctrl_frameCounter == 4'b0000) && (ctrl_address == io_config_deviceAddr));
  assign when_I2cDeviceCtrl_l168 = (((ctrl_frameCounter == 4'b0001) || ((! (ctrl_frameCounter == 4'b0000)) && (! (ctrl_frameCounter == 4'b0001)))) && (! ctrl_response_error));
  assign when_I2cDeviceCtrl_l172 = ((ctrl_read && (! (ctrl_frameCounter == 4'b0000))) && (((ctrl_frameCounter == 4'b0000) && (ctrl_bitCounter < 5'h08)) || ((! (ctrl_frameCounter == 4'b0000)) && (ctrl_bitCounter < 5'h08))));
  assign when_I2cDeviceCtrl_l176 = (sclEdge_rise && ctrl_transmission);
  assign when_I2cDeviceCtrl_l177 = (((ctrl_frameCounter == 4'b0000) && (ctrl_bitCounter < 5'h08)) || ((! (ctrl_frameCounter == 4'b0000)) && (ctrl_bitCounter < 5'h08)));
  assign when_I2cDeviceCtrl_l179 = ((ctrl_frameCounter == 4'b0000) && (ctrl_bitCounter == 5'h07));
  assign when_I2cDeviceCtrl_l184 = (sclEdge_fall && ctrl_transmission);
  assign when_I2cDeviceCtrl_l187 = (ctrl_bitCounter == 5'h08);
  always @(*) begin
    io_cmd_valid = 1'b0;
    case(ctrl_state)
      State_1_IDLE : begin
  ...
  assign when_I2cDeviceCtrl_l202 = (((! ctrl_cmdLock) && (ctrl_bitCounter == 5'h08)) && (((ctrl_frameCounter == 4'b0001) || (ctrl_read && (ctrl_frameCounter == 4'b0000))) || (ctrl_write && ((! (ctrl_frameCounter == 4'b0000)) && (! (ctrl_frameCounter == 4'b0001))))));
  ...
  always @(posedge clock) begin
    if(!reset) begin
      ...
      if(filter_clockDivider_io_tick) begin
      ...
      if(filter_clockDivider_io_tick) begin
        if(when_I2cDeviceCtrl_l79) begin
          filter_sda <= filter_sampler_sdaSamples_2;
        end
        if(when_I2cDeviceCtrl_l82) begin
      ...
      if(when_I2cDeviceCtrl_l113) begin
        timeout_value <= 16'h0;
      end
      if(when_I2cDeviceCtrl_l116) begin
      ...
      ctrl_sdaWrite <= 1'b0;
      if(when_I2cDeviceCtrl_l164) begin
        if(when_I2cDeviceCtrl_l165) begin
          ctrl_sdaWrite <= 1'b1;
        end
        if(when_I2cDeviceCtrl_l168) begin
          ctrl_sdaWrite <= 1'b1;
        end
      end
      if(when_I2cDeviceCtrl_l172) begin
        ctrl_sdaWrite <= (! _zz_ctrl_sdaWrite[_zz_ctrl_sdaWrite_1]);
      end
      case(ctrl_state)
        State_1_IDLE : begin
          if(when_I2cDeviceCtrl_l202) begin
  ...
  always @(posedge clock) begin
    ...
    if(when_I2cDeviceCtrl_l176) begin
      if(when_I2cDeviceCtrl_l177) begin
        ctrl_shiftRegister <= {ctrl_shiftRegister[9 : 0],filter_sda};
        if(when_I2cDeviceCtrl_l179) begin
          ctrl_read <= filter_sda;
        end
      end
    end
    if(when_I2cDeviceCtrl_l184) begin
      ctrl_bitCounter <= (ctrl_bitCounter + 5'h01);
      ctrl_cmdLock <= 1'b0;
      if(when_I2cDeviceCtrl_l187) begin
